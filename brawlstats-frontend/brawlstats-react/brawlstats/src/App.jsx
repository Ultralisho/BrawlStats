...
export default function App() {
  ...
  function login(u) { const d = { ...u, role: u.role || 'user' }; localStorage.setItem('bs_user', JSON.stringify(d)); setUser(d); }
  function logout() { localStorage.removeItem('bs_user'); setUser(null); }
